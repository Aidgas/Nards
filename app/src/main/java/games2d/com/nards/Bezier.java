...
public class Bezier {
    ...
    private PointPP[] bPoints;

    /**
     * Creates a new Bezier curve.
     * @param points
     */
    public Bezier(PointPP[] points)
    {
        int n = points.length;
        ...
        for (int i = 0; i < n - 2; i++)
        {
            ...
            bPoints[2 * i] = new PointPP((int) p1X, (int) p1Y);
            ...
            bPoints[2 * i + 1] = new PointPP((int) p2X, (int) p2Y);
        }
    }
